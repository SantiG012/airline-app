...
export class TuristicSitesComponent {
 images: readonly string[] = [
  "https://images.unsplash.com/photo-1539892613216-9e92b9257fd1?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80", 
